...
Q_IMPORT_QML_PLUGIN(ModbusAssistantUIContentPlugin)
Q_IMPORT_QML_PLUGIN(ModbusAssistantUIPlugin)

const char mainQmlFile[] = "qrc:/qt/qml/ModbusAssistantUIContent/App.qml";
